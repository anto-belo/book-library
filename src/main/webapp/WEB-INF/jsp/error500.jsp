...
<div class="container" style="margin-top: 100px;"><i
        class="fa fa-server d-lg-flex justify-content-lg-center flash animated infinite"
        style="font-size: 150px;color: var(--bs-gray-500);"></i>
    <h1 style="font-size: 80px;text-align: center;">Oops!</h1>
    <h1 style="text-align: center;">It looks like you have a 500 error :(</h1>
    <p class="text-center">We are already working on it, but in the meantime, try to go to the&nbsp;<a
